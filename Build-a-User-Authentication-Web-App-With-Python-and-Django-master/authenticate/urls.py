...
urlpatterns = [
    ...
    path('first-question', views.first_question, name='first_question'),
    path('second_question', views.second_question, name='second_question'),
    path('end-form', views.end_form, name='end_form'),
    path('third_question', views.third_question, name='third_question'),
    path('second-question', views.stop_first_question, name='stop_first_question'),
    path('third-question', views.stop_second_question, name='stop_second_question'),
